...
<body>
    ...
    <!-- Welcome message -->
    <center>
        <h2 style="text-align: center; color: #000000;"class="welcome">WELCOME <i><?php echo $login_user; ?></i></h2>
    </center>

    <!-- Main content with action buttons -->
    <div class="container">
        <a href="userviewupdate.php?q=<?php echo $login_user; ?>" class="menu-item">
            <div style="background-image: url('images/view.png');"></div>
            <p>VIEW AND UPDATE MY DETAILS</p>
        </a>

        <a href="newcomplaint.php?q=<?php echo $login_user; ?>" class="menu-item">
            <div style="background-image: url('images/new.png');"></div>
            <p>NEW COMPLAINT</p>
        </a>

        <a href="checkstatus.php?q=<?php echo $login_user; ?>" class="menu-item">
            <div style="background-image: url('images/status.png');"></div>
